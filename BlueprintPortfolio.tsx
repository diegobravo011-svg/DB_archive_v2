...
export default function BlueprintPortfolio() {
  ...
  return (
    <>
      {/* Global styles — add to your globals.css instead if preferred */}
      <style>{`
        ...
        .bp-grid-bg {
          ...
          inset: 0;
          background-image:
            linear-gradient(rgba(100,160,240,0.04) 1px, transparent 1px),
            linear-gradient(90deg, rgba(100,160,240,0.04) 1px, transparent 1px);
        ...
        .bp-grid-bg::before {
          ...
          inset: 0;
          background-image:
            linear-gradient(rgba(100,160,240,0.015) 1px, transparent 1px),
            linear-gradient(90deg, rgba(100,160,240,0.015) 1px, transparent 1px);
        ...
        .bp-crosshair::before, .bp-crosshair::after {
          content: '';
          position: absolute;
          background: rgba(100,160,240,0.25);
        }
        .bp-crosshair::before { width: 1px; height: 100%; left: 50%; transform: translateX(-50%); }
        .bp-crosshair::after  { height: 1px; width: 100%; top: 50%; transform: translateY(-50%); }
      `}</style>

      <div className="bp-root" ref={containerRef}>
          ...
          <div className="bp-fade-in" style={{
            ...
            {NOTES.map((note, i) => (
              <div key={i} style={{
                ...
                {note.italic
                  ? <em style={{ fontFamily: "'Instrument Serif', serif", fontStyle: "italic", fontSize: 12, color: "rgba(168,196,232,0.65)" }}>{note.text}</em>
                  : note.text
                }
              </div>
            ))}
